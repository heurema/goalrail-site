...
export const metadata = pageMeta(
  "FAQ",
  "Answers to common questions about Goalrail: what it is, how it works, and how to get started.",
  {
    eyebrow: "Help",
    path: "/en/faq",
  },
        ...
        <div className="wrap">
          <section className="section">
            ...
            <p className="muted">
              ...
              Azure, vLLM), or a local model endpoint.
            </p>

            <h3>How do I run my own agent?</h3>
            <p className="muted">
              Write a short YAML file with a prompt and a harness, then run{" "}
              <code>goalrail run</code> on it. See the{" "}
              <Link href="/en/docs/use/custom-agents">custom agent guide</Link>.
            </p>
            ...
            <h3>Do I need a cloud provider?</h3>
            <p className="muted">
              No. Goalrail is open source and runs on your own machine and
              models. A compatible API gateway is optional, not required.
            </p>
