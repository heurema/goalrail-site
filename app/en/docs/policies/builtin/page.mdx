...
export const metadata = pageMeta(
  "Builtin Policies",
  "Built-in Goalrail policies for common safety and cost-control guardrails. Apply them by name or reference them in YAML.",
  {
    eyebrow: "Policies",
    path: "/en/docs/policies/builtin",
  },
);
...
these by name when you [ask it to add a policy](/en/docs/policies/overview#adding-a-policy), or you
